...
class JobsPage(QWidget):
    ...
    def __init__(self, container: Container, parent: QWidget | None = None) -> None:
        ...
        cancel_btn.setToolTip("Cancel selected pending/running jobs.")
        retry_btn.setToolTip("Re-queue selected failed jobs.")
        refresh_btn.setToolTip("Reload job list from the database.")
