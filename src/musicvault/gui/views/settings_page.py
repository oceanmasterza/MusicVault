...
from musicvault.gui.widgets.scrollable import wrap_scrollable
...
class SettingsPage(QWidget):
    ...
    def __init__(self, container: Container, parent: QWidget | None = None) -> None:
        ...
        self._acoustid_key.setToolTip(
            ...
            "Restart MusicVault after saving."
        )
        ...
        fingerprint_help = QLabel(
            ...
            "Requires an AcoustID API key. Restart MusicVault after changing these settings."
        )
    ...
    def _save_preferences(self) -> None:
        ...
        QMessageBox.information(
            self,
            "Settings",
            "Preferences saved. Restart MusicVault so fingerprinting and AcoustID "
