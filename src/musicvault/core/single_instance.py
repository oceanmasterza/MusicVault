"""Ensure only one MusicVault GUI/headless process owns the app database.

Without this, a second launch (or a multiprocessing child that mistakenly
re-enters :mod:`musicvault.__main__`) opens the same SQLite file, hits
...
class SingleInstanceLock:
    ...
    def __init__(self, name: str = "Local\\MusicVaultSingleInstance") -> None:
        self._name = name
