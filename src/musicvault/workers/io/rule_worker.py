...
evaluates enabled rules, and applies safe actions (flag review, set
artist/genre). Zone moves are parked as review items until Phase 10.
"""
...
class RuleWorker:
    ...
    def execute(self, job: Job) -> None:
        ...
        context = self._rules.build_context(track)
