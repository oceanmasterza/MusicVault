...
:mod:`musicvault.services.job_queue_service` for that boundary.
"""
...
from musicvault.db.tables import metadata
...
class DatabaseWriter:
    ...
    def start(self) -> None:
        ...
        self._thread = threading.Thread(target=self._run, name="musicvault-db-writer", daemon=True)
        self._thread.start()
