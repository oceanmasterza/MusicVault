...
is SQL in :class:`~musicvault.db.repositories.duplicate_repo.DuplicateRepository`;
...
:class:`~musicvault.models.services.quality_scorer.QualityScorer`.
...
from musicvault.models.services.quality_scorer import QualityScorer
